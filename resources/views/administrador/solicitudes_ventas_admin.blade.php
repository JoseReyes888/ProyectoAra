...
<head>
    ...
    <title>Solicitudes de Ventas | Inmobiliaria</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@500;600&display=swap" rel="stylesheet">
    <link href="{{ asset('css/administrador/solicitudes_ventas_admin.css') }}" rel="stylesheet">
</head>
<body>
    <div class="container">
        <!-- Encabezado -->
        <div class="page-header">
            <h1 class="page-title">
                ...
                <span>Solicitudes de Ventas</span>
            </h1>
            <div class="page-actions">
                <button class="btn btn-outline" onclick="window.location.href='ventas_admin'" aria-label="Volver a la página anterior">
            ...
            <div class="solicitud-card">
                ...
                <div class="solicitud-body">
                    <div class="details-grid">
                        ...
                        <div class="detail-item">
                            <span class="detail-label">Monto de la venta:</span>
                            <span class="detail-value">$1,250,000 MXN</span>
                        </div>
                    </div>

                    <div class="ticket-preview">
                        <img src="ruta_al_ticket_venta.jpg" alt="Comprobante de pago de la solicitud de venta">
                        <button class="btn btn-outline" onclick="openTicketModal('ruta_al_ticket_venta.jpg')" aria-label="Ver comprobante de pago en tamaño completo">
                            <i class="fas fa-expand" aria-hidden="true"></i> Ver completo
                        </button>
                    </div>

                    <div class="action-buttons">
                        <button class="btn btn-success" onclick="confirmarVenta('V-2025-001')" aria-label="Confirmar venta V-2025-001">
                            <i class="fas fa-check" aria-hidden="true"></i> Confirmar Venta
                        </button>
                        <button class="btn btn-danger" onclick="agregarObservacion('V-2025-001')" aria-label="Agregar observación a la solicitud V-2025-001">
            ...
            <div class="solicitud-card">
                ...
                <div class="solicitud-body">
                    <div class="details-grid">
                        ...
                        <div class="detail-item">
                            <span class="detail-label">Monto de la venta:</span>
                            <span class="detail-value">$1,500,000 MXN</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="solicitud-card">
                ...
                <div class="solicitud-body">
                    <div class="details-grid">
                        ...
                        <div class="detail-item">
                            <span class="detail-label">Monto de la venta:</span>
                            <span class="detail-value">$1,000,000 MXN</span>
                        </div>
                    </div>

                    <div class="admin-comment observation">
                        <i class="fas fa-exclamation-circle" aria-hidden="true"></i>
                        <p>El comprobante de pago no corresponde al monto especificado. Por favor, verificar y enviar el comprobante correcto.</p>
    ...
    <script>
        ...
        function confirmarVenta(id) {
            if (confirm('¿Estás seguro de confirmar esta venta?')) {
                // Aquí iría la lógica para confirmar la venta y actualizar el plano SVG
                alert('Venta confirmada correctamente');
                // Placeholder para actualizar el plano SVG
                // Ejemplo: updateSvgMap(id, 'vendido', 'green');
            }
        }
